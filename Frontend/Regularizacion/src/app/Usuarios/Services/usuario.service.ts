...
import { TipoUsuario } from '../../Regularizacion/shared/Usuario/Enums/TipoUsuario';
...
export class UsuarioService {
  ...
  deleteUsuario(id: string, usuario: TipoUsuario): Observable<any> {
    const url = `${this.urlCliente}DeleteUsuario/${id}/${usuario}`;
    return this.http.delete(url);
  }
  /*  ############################## Fin Clientes ##############################*/
  /*  ############################## INICIO Familiares ##############################*/
